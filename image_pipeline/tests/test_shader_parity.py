...
def test_gpu_shader_node_map_resolves():
    ...
    # Stable count guard: 47 GPU shader nodes + 23 P0 CPU-twin shims
    # (02, 04, 03, 06, 07, 08, 105, 05, 29, 33, 51, 52, 66, 67, 69,
    #  12, 17, 41, 80, 42, 63, 64, 74)
    # + 17 P1 GPU-sims (155, 32, 18, 58, 91, 118, 119, 120, 121, 133, 143, 160,
    # 168, 169, 100, 144, 166) = 87.
    # Bump this when a new shim/sim is added.
    assert len(GPU_SHADER_NODE_MAP) == 87, len(GPU_SHADER_NODE_MAP)
