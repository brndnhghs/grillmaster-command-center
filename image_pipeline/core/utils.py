...
# Extended palette registry with built-in + matplotlib colormaps + user-installed.
# All existing code that does `from ...utils import PALETTES` continues to work.
from .palette_registry import (
    PALETTES as _REGISTRY,
    get_all as _get_all_palettes,
    get as _get_palette,
    register as _register_palette,
    remove as _remove_palette,
    list_categories as _list_palette_categories,
    get_source as _get_palette_source,
    extract_colors_from_vscode_theme,
)

PALETTES: dict[str, list[tuple[int, int, int]]] = _get_all_palettes()
