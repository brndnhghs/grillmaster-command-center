...
# three.js 3D node definitions live in core/threejs_nodes (TD-07 / ROADMAP R8):
# extracted from this module so graph execution stays focused on execution.
from .threejs_nodes import (
    THREEJS_3D_NODE_DEFS as _THREEJS_3D_NODE_DEFS,
    THREEJS_POSTFX_PARAMS as _THREEJS_POSTFX_PARAMS,
    MODEL_PLACEMENT_PARAMS as _MODEL_PLACEMENT_PARAMS,
)
@cache
