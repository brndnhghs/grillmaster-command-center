...
def method_lowpoly(out_dir: Path, seed: int, params=None):
    ...
    light_ang = sparam(params, "light_angle", 45)
    light_alt = sparam(params, "light_altitude", 30)
    extrude = float(params.get("extrusion_scale", 0.5))
    grad_blend = sparam(params, "gradient_blend", 0.5)
