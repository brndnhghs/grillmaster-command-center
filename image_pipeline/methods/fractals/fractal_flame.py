...
def method_fractal_flame(out_dir: Path, seed: int, params=None):
    ...
    n_points = sparam(params, "points", 200000)
    ...
    c_decay = sparam(params, "color_decay", 0.99)
