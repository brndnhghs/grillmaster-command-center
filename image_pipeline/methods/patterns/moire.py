...
def method_moire(out_dir: Path, seed: int, params=None):
    ...
    try:
        ...
        freq = sparam(params, "frequency", 0.06)
        freq_var = sparam(params, "freq_variation", 0.3)
