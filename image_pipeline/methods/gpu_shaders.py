...
GPU_PREVIEW_DROP_ALLOW: dict[str, dict[str, str]] = {
    "02": {"mod_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "03": {"amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "freq_variation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grids": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "thickness": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "wobble": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "04": {"cell_border": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "feature": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "fractal": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "points": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tile_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "05": {"cell_borders": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "cell_points": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "domain_warp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "erosion": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "gain": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "lacunarity": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "ring_count": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "ring_wobble": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "water_level": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "06": {"gap": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "penrose_generations": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "star_rays": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tile_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "07": {"color_variation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "gap": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "rotation_noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "08": {"center_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "center_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "fade": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "petal_angle": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "point_size_max": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "point_size_min": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "rotation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "11": {"direction": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "13": {"error_scale": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "16": {"color_hue": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "freq": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "line_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_particles": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_waves": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "trail_length": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "17": {"bit_depth": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "channel_offset": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "jpeg_quality": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_blocks": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "scanlines": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "shift_count": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "shift_magnitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "shift_max_height": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "vhs_tracking": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "wave_distort": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "18": {"age_input": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "cell_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "hue_shift": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_select": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "inject_rate": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "rule_select": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "seed_threshold": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "wave_phase": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "29": {"line_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "31": {"erosion": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "light_angle": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "roughness_decay": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "water_level": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "32": {"bias_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "bias_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "feedback_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "inject_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "inject_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "inject_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "iterations": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "particle_count": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "particle_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "perturbations": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "seed_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "33": {"trap_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "trap_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "trap_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "warp_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "39": {"n_colors": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "41": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "brush_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "edge_threshold": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_offset": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "quantize_levels": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "42": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "exposure": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "gamma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tint_b": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tint_g": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tint_r": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "43": {"contour_levels": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "light_alt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "light_angle": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_clusters": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "point_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "points": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "ridge_spacing": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "scatter_alpha": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "51": {"anim_zoom_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "antialias": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "escape_radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "exponent": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "warp_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "52": {"anim_float_amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "anim_zoom_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tol": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "warp_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "53": {"balls": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "color_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "multi_threshold_levels": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "radius_max": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "radius_min": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "trail_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "56": {"braid": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "color_saturation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "growing_bias": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "loops": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "multi_seed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "rings": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "57": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "feedback_decay": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tint_b": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tint_g": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tint_r": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "58": {"hue_shift": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_select": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "rule_select": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "63": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "speckle_count": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "thread_density": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "thread_variation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "64": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "canny_high": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "canny_low": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dot_variation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "65": {"amplitude_ratio": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "decay_rate": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "fill_alpha": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "line_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "mod_depth": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "mod_freq": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_level": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "num_bars": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "num_tracks": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "pulse_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "66": {"warp_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "68": {"blend": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "presmooth": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "69": {"measure": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "seed_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "warmup": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "74": {"amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "frequency": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "rotation": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "segments": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "zoom": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "78": {"attempts": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "concentric_rings": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "gap": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "halftone_density": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "max_circles": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "outline_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "relaxation_iters": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "sunburst_rays": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "80": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grout_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "tile_jitter": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "81": {"line_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_circles": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "offset_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "offset_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "scale": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "trace_fade": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "trace_length": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "87": {"grid_scale": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "91": {"Dv": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "93": {"L": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "T_min": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "updates_per_frame": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "95": {"burn_in": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_h": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_w": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "96": {"grid_h": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_w": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "99": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "substeps": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "100": {"gamma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_sources": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_steps_per_frame": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "orbit_radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "orbit_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "pulse_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "source_spread": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "104": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "osc_spread": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "twist_amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "twist_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "105": {"grid_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "106": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "seeds": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "spark_prob": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "118": {"dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "du": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dv": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "119": {"dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "du": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dv": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "120": {"dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "121": {"dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "du_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "du_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dv_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dv_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "122": {"impurity_density": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_seeds": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "124": {"amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "background_noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "initial_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_solitons": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "phase_strength": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "plane_wave_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "single_momentum": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "soliton_momentum": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "soliton_offset": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "substeps": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "vortex_radius_ratio": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "125": {"breathe_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "m_end": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_end": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_modes": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "nodal_glow": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "phase_speed_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "sigmoid_gain": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "126": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_seeds": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "spiral_r": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "substeps": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "wave_k": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "127": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "substeps": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "128": {"grid_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "substeps": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "132": {"dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_div": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_obstacles": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_sources": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "obstacle_radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "obstacle_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "obstacle_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "133": {"amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "diff_v": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "135": {"amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_div": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "142": {"morph_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "143": {"diff_n": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_intensity": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "144": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "nonlinear": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "146": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "148": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "150": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "153": {"grid_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_coop": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "mutation_rate": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "steps_per_frame": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "154": {"diffusion_rate": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_size": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_coop": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "mutation_rate": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "steps_per_frame": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "155": {"cell_max": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "cell_min": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grad_sweep": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "157": {"morph_speed": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "160": {"diff_n": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_intensity": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "161": {"dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "162": {"coupling": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_div": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "init_amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "163": {"diff_u": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid_div": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "164": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "166": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "nonlinear": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "pump_ratio": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "168": {"K": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "alpha": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "bias": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "169": {"Dv": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "dt": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "growth_rate": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "170": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "psi0": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "172": {"n_frames": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "311": {"gain": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "lacunarity": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "warp_levels": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "312": {"amplitude": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "waves": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "314": {"line_density": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    ...
    "339": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "source_blur": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "345": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "presmooth": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "z_bins": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "348": {"capacity": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "droplets": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "gravity": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "grid": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "height_scale": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "inertia": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "lifetime": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "light_angle": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "octaves": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "roughness": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "350": {"noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "402": {"escape_radius": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "iterations": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "offset_x": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "offset_y": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "406": {"color_shift": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "damping": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "freq3": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "freq4": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "line_width": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "samples": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "408": {"iterations": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "409": {"n1": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n2": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n3": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "palette_shift": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "spread": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "417": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "419": {"noise_scale": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "422": {"blur_sigma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "noise_amp": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "432": {"brightness": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "hue": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "464": {"noise_freq": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "473": {"contrast": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "scale": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
    "499": {"gamma": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)", "n_steps_per_frame": "legacy client-GPU twin lacks a GPU slot; CPU export is authoritative (GPU coverage contract: explicit drop)"},
}
